...
function Carrier(reader, listener, encoding) {
  ...
  var ender = function() {
    ...
    var set_mycallback = function(callback_name){
	self.callback = callback_name;
	console.log('I am set callback', callback_name);
    }
    self.addListener('set_callback', set_mycallback);  
